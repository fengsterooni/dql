import numpy as np
import torch as T
from deep_q_network import DeepQNetowrk, DuelingDeepQNetwork
...
class DQNAgent(Agent):
    def __init__(self, *args, **kwargs):
        ...
        self.q_eval = DeepQNetowrk(self.lr, self.n_actions,
                                   input_dims=self.input_dims,
                                   name=self.env_name+'_'+self.algo+'_q_eval',
                                   chkpt_dir=self.chkpt_dir)

        self.q_next = DeepQNetowrk(self.lr, self.n_actions,
                                   input_dims=self.input_dims,
